...
hero:
  ...
  opcoes:
    ...
    voce: "Para você"
  imagemFundo:
    id: "IMG-HOME-HERO-FUNDO"
    arquivo: "home-hero-fundo"
...
como:
  ...
  etapas:
    - titulo: "Você conta o que precisa"
      texto: "Pelo formulário aqui mesmo ou pelo WhatsApp. São quatro passos, quase todos de tocar numa opção."
      imagem:
        id: "IMG-HOME-COMO-1"
        arquivo: "home-como-1"
    ...
    - titulo: "Começa"
      texto: "A aula, a turma de NR-1 ou o evento, presencial ou online, na data combinada."
      imagem:
        id: "IMG-HOME-COMO-4"
        arquivo: "home-como-4"
...
depoimentos:
  ...
  itens:
    - trecho: "Em momentos decisivos para o nosso negócio, cada palavra importa."
      ...
      pendencia: "[CONFIRMAR COM A DANIELLA: autorização por escrito de Eduardo Martins, da Nissan, e confirmação de que a fala é dele]"
    - trecho: "Na produção, cada decisão precisa ser clara e bem compreendida. (...) sentimos uma diferença imediata na forma como nossas equipes globais se conectavam."
      ...
      servico: "Tradução simultânea"
      pendencia: "[CONFIRMAR COM A DANIELLA: autorização por escrito de Bruno Teixeira, da General Motors, e confirmação de que a fala é dele]"
    - trecho: "Os professores são altamente qualificados e preparados para atender executivos e líderes (...)."
      ...
      pendencia: "[CONFIRMAR COM A DANIELLA: autorização por escrito de Pedro Cavalcante, da Embraer, e confirmação de que a fala é dele]"
